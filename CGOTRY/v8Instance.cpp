...
int v8Instance::v8WorkLoad(std::string jsFile,const char* code){
    ...
    v8::Local<v8::String> jsCode=v8::String::NewFromUtf8(isolate_, code);
    if(!ExecuteScript(jsCode,file_name)){
